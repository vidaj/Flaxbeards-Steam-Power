        ...
        if (Config.enableExosuit && Config.enableEngineering) {
            ...
            if (Config.enableFrequencyShifter) {
                SteamcraftRegistry.addResearch(
                  ...
                  new BookPageItem("research.FrequencyShifter.name",
                    "research.FrequencyShifter.0", true,
                    new ItemStack(SteamcraftItems.frequencyShifter)),
                  new BookPageCrafting("", "frequencyShifter1", "frequencyShifter2")
                );
            }
            ...
            if (Config.enableRebreather) {
                SteamcraftRegistry.addResearch(
                  ...
                  new BookPageItem("research.Rebreather.name",
                    "research.Rebreather.0", true,
            ...
            if (Config.enableDragonRoar) {
                SteamcraftRegistry.addResearch(
                  ...
                  "!research.ExoHeadGoggle.name",
                  new BookPageItem("research.DragonRoar.name",
                    "research.DragonRoar.0", true,
                    new ItemStack(SteamcraftItems.dragonRoar)),
                  new BookPageCrafting("", "dragonRoar1", "dragonRoar2")
                );
            }
            ...
            if (Config.enablePistonPush) {
                SteamcraftRegistry.addResearch(
                  ...
                  new BookPageItem("research.PistonPush.name",
                    "research.PistonPush.0", true,
            ...
            if (Config.enableReloadingHolsters) {
                SteamcraftRegistry.addResearch(
                  ...
                  new BookPageItem("research.ReloadingHolsters.name",
                    "research.ReloadingHolsters.0", true,
                    new ItemStack(SteamcraftItems.reloadingHolsters)),
                  new BookPageCrafting("", "reloadingHolsters1", "reloadingHolsters2")
                );
            }
            ...
            if (Config.enableAnchorHeels) {
                if (Config.enableAnchorIronRecipe) {
                    SteamcraftRegistry.addResearch(
                      ...
                      new BookPageCrafting("", "anchorHeels1", "anchorHeels2")
                    );
                } else {
                    SteamcraftRegistry.addResearch(
                      "research.AnchorHeels.name",
            ...
            if (Config.enableHydrophobic) {
                SteamcraftRegistry.addResearch(
                  ...
                  new BookPageItem("research.Hydrophobic.name",
                    "research.Hydrophobic.0", true,
                    new ItemStack(SteamcraftItems.coatingsHydrophobic)),
                  new BookPageCrafting("", "hydrophobic1", "hydrophobic2")
                );
            }
            if (Config.enablePyrophobic) {
                SteamcraftRegistry.addResearch(
                  "research.Pyrophobic.name",
                  "!research.ExoFoot.name",
                  new BookPageItem("research.Pyrophobic.name",
                    "research.Pyrophobic.0", true,
                    new ItemStack(SteamcraftItems.coatingsPyrophobic)),
                  new BookPageCrafting("", "pyrophobic1", "pyrophobic2")
                );
            }
